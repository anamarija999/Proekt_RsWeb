        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VrabotenId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Vraboten", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstEmployeeId = table.Column<int>(nullable: true),
                    SecondEmployeeId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Usluga", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Usluga_Vraboten_FirstEmployeeId",
                        column: x => x.FirstEmployeeId,
                        principalTable: "Vraboten",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Usluga_Vraboten_SecondEmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Usluga_FirstEmployeeId",
                table: "Usluga",
                column: "FirstEmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Usluga_SecondEmployeeId",
                table: "Usluga",
